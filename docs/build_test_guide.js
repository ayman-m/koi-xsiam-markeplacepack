...
/* ---------- Script Runner: what to put in place (its own slide) ---------- */
{
  ...
  s.addText("KoiScanTracker — an automation, not a playbook, and separate from the KOI deployment script opposite. Manual import takes one file: Packs/KoiContentExtension/dist/automation-KoiScanTracker.yml",
  ...
  rowList(s, [
    ...
    "Automation → Scripts → Import → Packs/KoiContentExtension/dist/automation-KoiScanTracker.yml",
    "Settings → Object Setup → Lists → New List, type JSON, named exactly Koi Script Runner. Paste the block from Packs/KoiContentExtension/Lists/README.md.",
